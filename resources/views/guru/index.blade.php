                        ...
                        <tbody>
                            @foreach ($siswas as $siswa)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3"><img src="/storage/bukti/{{ $siswa->bukti }}" alt="" width="100px"></td>
                                    <td class="px-4 py-3" style="min-width: 200px">
                                        <span class="bg-green-400 text-white rounded-lg p-1
                                            @if ($siswa->status == 'Sedang dalam Tinjauan') bg-red-400 text-white rounded-lg p-1
